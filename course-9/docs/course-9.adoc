...
Diese Softwarequalität lässt sich aber sehr oft auf recht einfache Weise und meistens auch schnell verbessern.

Auch wenn man selbst die Qualität des eigenen Codes manchmal nur schwer bewerten kann, gibt es eine Reihe von Tools, Methoden und Hilfestellungen, die man nutzen kann. Dazu gehören:
...
[subs=normal]
 {course-9-src}/refactoring/BeforeRefactoring.java
