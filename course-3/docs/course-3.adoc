...
Weitere Beispiele finden sich in
 ...
 course-3/test/de/dhbw/course3/study/StreamingTest.java
...
.de/dhbw/course3/study/MyStudyTests.java
[source, java]
----
include::{tests-from-course-3}/de/dhbw/course3/study/MyStudyTests.java[tags="old-fashioned-reduce"]
----
...
Übung 3::
In der Testklasse finden sich kleine "Quizfragen" für die Inhalte des Kurses 3:
