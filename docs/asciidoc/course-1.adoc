...
image::diagrams/course-1/reference-semantics-prim.svg["RefSemPrim",width="50%",align="center"]
...
image::diagrams/course-1/reference-semantics-obj.svg["RefSemObj",width="50%",align="center"]


=== Übungsaufgaben

Übungsaufgabe 1::
Erzeuge ein eigenes Klassenmodell mit Klassen aus dem oben dargestellten Klassenmodell!
