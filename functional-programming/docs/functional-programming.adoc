...
Implementiere eine Liste mit mehreren bool'schen Werten. Nutze dann einen Lambda-Ausdruck, durch den die Listenelemente auf der Konsole ausgegeben werden können.
