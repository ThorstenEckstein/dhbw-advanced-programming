...
Setzen das Prinzip *Information Hiding* um, indem in den Beispiel-Klassen im Paket

 de.dhbw.course2.basics.collections.nm

die zu den vorhandenen Attributen gehörenden `getter` und `setter` Methoden eingeführt werden. Außerdem muss noch der zugehörige Unit-Test entsprechend angepasst werden:
