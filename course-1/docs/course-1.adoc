...
Ist eine gute Praxis, um seinen Code von Beginn an - mithilfe von Unit-Tests regelmäßig und bei Änderungen auf Korrektheit zu überprüfen. Dazu gibt es z.B. die Strukturen `given-when-then` oder `arrange-act-assert`.

*Exkurs*. Eigenschaften von Unit-Tests
