package de.juwi.pattern.filter.v2.impl;

import de.juwi.pattern.filter.v2.AnalysisCase;
import de.juwi.pattern.filter.v2.AnalysisDetail;
import de.juwi.pattern.filter.v2.MatchException;
import de.juwi.pattern.filter.v2.Matcher;
import de.juwi.pattern.filter.v2.MatcherChain;
