...
CAUTION: _Das ist ein sogenanntes "Anti-Pattern", weil die wahre Fehlerursache hierdurch sehr schnell verschleiert wird!_
...
CAUTION: _Ein weiteres "Anti-Pattern" ist das sogenannte "throw-rethrow" Muster. Auch dieses erschwert stark das Erkennen der Fehlerursache und erzeugt einfach viel Code ("Boiler-Plate-Code")_
